...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(int p0, UnityEngine.RectTransform p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CustomScroll.RenderDelegate))
			{
			    return new CustomScroll.RenderDelegate(__Gen_Delegate_Imp11);
			}
